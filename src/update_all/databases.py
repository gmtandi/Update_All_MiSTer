...
class AllDBs:
    UPDATE_ALL_MISTER = Database(db_id='update_all_mister', db_url='https://raw.githubusercontent.com/gmtandi/Update_All_MiSTer/db/update_all_db.json', title='Update All files')
